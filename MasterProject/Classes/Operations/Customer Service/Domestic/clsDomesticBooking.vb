Public Class clsDomesticBookingHeader
    ...
    Private clsMasterBookingDetails As New clsDomesticMasterBooking
    Property _MasterBookingDetails As clsDomesticMasterBooking
        Get
            Return clsMasterBookingDetails
        End Get
        Set(value As clsDomesticMasterBooking)
    ...
    Private clsServiceDetails As New List(Of clsDomesticBookingServices)
    Property _ServiceDetails As List(Of clsDomesticBookingServices)
        Get
            Return clsServiceDetails
        End Get
        Set(value As List(Of clsDomesticBookingServices))
            clsServiceDetails = value
        End Set
    End Property

    Private clsDocumentDetails As New List(Of clsDomesticBookingDocuments)
    Property _DocumentDetails As List(Of clsDomesticBookingDocuments)
        Get
            Return clsDocumentDetails
        End Get
        Set(value As List(Of clsDomesticBookingDocuments))
...
Public Class clsDomesticBookingServices
    Private lngID As Long
    Property _ID As Long
        Get
            Return lngID
...
Public Class clsDomesticBookingDocuments
    Private lngID As Long
    Property _ID As Long
        Get
            Return lngID
