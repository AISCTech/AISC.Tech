...
Public Class frmExportSeaTariffForwFCL
    ...
    Private Sub frmExportSeaTariffForwFCL_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub SearchTariff(ByVal str As String)
        ...
        strSQL = "SELECT * " &
                     "FROM tbl_expsea_tariff_fcl_forw where PK = '" & str & "'"
    ...
    Public Sub SaveTariff()
        ...
        If Len(Me.txtPK.Text) = 0 Then
            ...
            Try
                cmdSQL.CommandText = ("INSERT INTO tbl_expsea_tariff_fcl_forw (`PK`, `ChargeCode`, `ChargeDesc`, `DirectTranshipment`, `TranshipmentPort`, `TranshipmentFinalDest`, `DirectPort`, `ShippingLineCode`, `ShippingLineName`, `Price20FT`, `UOM20FT`, `Currency20FT`, `Price40FT`, `UOM40FT`, `Currency40FT`, `SellingPrice20FT`, `SellingUOM20FT`, `SellingCurrency20FT`, `SellingPrice40FT`, `SellingUOM40FT`, `SellingCurrency40FT`, `Type`, `Remarks`, `EncodedBy`, `EncodedDate`, `ModifiedBy`, `ModifiedDate`)  VALUES " &
                ...
                With cmdSQL.Parameters
                    Dim strPK As String = "108" & GetCtrlNbr(strCompanyCode, strSiteCode, "Charges_ExpSea_FCL")
            ...
            UpdateCtrlNbrCounter(strCompanyCode, strSiteCode, "Charges_ExpSea_FCL")

            MsgBox("Record Successfully Saved!", vbInformation, "System Message")
            ChangeEnabledButtons(True, True, False, False, True, True, True, True, True, False)

            'save transaction log
            SaveTransLogs("Create New", Me.Name, "Tariff Rate ExpSeaFCL Forw", Me.txtPK.Text, strCurrentUser)

        Else
            'update record

            Dim sSQL As String = "UPDATE tbl_expsea_tariff_lcl_forw Set "
            ...
            Me.tstripModifiedBy.Text = strCurrentUser
            Me.tstripModifiedDate.Text = Format(dtCurrent, "yyyy-MM-dd hh:mm:ss")
            SaveTransLogs("Edit Record", Me.Name, "Tariff Rate ExpSeaFCL Forw", Me.txtPK.Text, strCurrentUser)
        End If
    ...
    Public Sub PopTariff(ByVal dg As DataGridView)
        ...
        strSQL = "SELECT * " &
                     "FROM tbl_expsea_tariff_fcl_forw"
    ...
    Private Sub frmExportSeaTariffForwFCL_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        EnableButtons.UpdateEnabledButtons()
    End Sub

    Private Sub cboDirectPort_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboDirectPort.SelectedIndexChanged
