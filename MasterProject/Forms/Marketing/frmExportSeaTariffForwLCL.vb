...
Public Class frmExportSeaTariffForwLCL
    ...
    Private Sub frmExportSeaTariffForwLCL_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub SearchTariff(ByVal str As String)
        ...
        strSQL = "SELECT * " &
                     "FROM tbl_expsea_tariff_lcl_forw where PK = '" & str & "'"
    ...
    Public Sub SaveTariff()
        ...
        If Len(Me.txtPK.Text) = 0 Then
            ...
            Try
                cmdSQL.CommandText = ("INSERT INTO tbl_expsea_tariff_lcl_forw (`PK`, `ChargeCode`, `ChargeDesc`, `DirectTranshipment`, `TranshipmentPort`, `TranshipmentFinalDest`, `DirectPort`, `Price`, `UOM`, `Currency`, `SellingPrice`, `SellingUOM`, `SellingCurrency`, `Type`, `Remarks`, `EncodedBy`, `EncodedDate`, `ModifiedBy`, `ModifiedDate`)  VALUES " &
                ...
                With cmdSQL.Parameters
                    Dim strPK As String = "104" & GetCtrlNbr(strCompanyCode, strSiteCode, "Charges_ExpSea_LCL")
            ...
            UpdateCtrlNbrCounter(strCompanyCode, strSiteCode, "Charges_ExpSea_LCL")

            MsgBox("Record Successfully Saved!", vbInformation, "System Message")
            ChangeEnabledButtons(True, True, False, False, True, True, True, True, True, False)

            'save transaction log
            SaveTransLogs("Create New", Me.Name, "Tariff Rate ExpSeaLCL Forw", Me.txtPK.Text, strCurrentUser)
        ...
        Else
            ...
            Me.tstripModifiedBy.Text = strCurrentUser
            Me.tstripModifiedDate.Text = Format(dtCurrent, "yyyy-MM-dd hh:mm:ss")
            SaveTransLogs("Edit Record", Me.Name, "Tariff Rate ExpSeaLCL Forw", Me.txtPK.Text, strCurrentUser)
        End If
    ...
    Public Sub PopTariff(ByVal dg As DataGridView)
        ...
        strSQL = "SELECT * " &
                     "FROM tbl_expsea_tariff_lcl_forw"
    ...
    Private Sub frmExportSeaTariffForwLCL_Activated(sender As Object, e As EventArgs) Handles Me.Activated
