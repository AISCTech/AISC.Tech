...
Public Class frmPettyCashRelease
    ...
    Private Sub SaveEntry(ByVal strPCRNo As String)
        ...
        For ctrRow As Integer = 0 To Me.dtgPCReleaseEntry.Rows.Count - 1
            ...
            InsertToGLTable(8, GetGeneralLedgerModuleName(8), strPCRNo, dtgEntryRow.Cells("colAcctCode").Value, dtgEntryRow.Cells("colAcctTitle").Value, dtgEntryRow.Cells("colSubCode").Value, dtgEntryRow.Cells("colSubAcctTitle").Value, CDbl(dtgEntryRow.Cells("colDR").Value), CDbl(dtgEntryRow.Cells("colCR").Value), dtgEntryRow.Cells("colchkDept").Value, dtgEntryRow.Cells("colDeptName").Value, dtgEntryRow.Cells("colchkList").Value, dtgEntryRow.Cells("colListItem").Value, dtgEntryRow.Cells("colListItemName").Value)
        Next
    End Sub
