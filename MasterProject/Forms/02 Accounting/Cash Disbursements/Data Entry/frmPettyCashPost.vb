...
Public Class frmPettyCashPost
    ...
    Private Sub Post(ByVal str As String)
        ...
        Else
            ...
            DeleteToGLTable(frmPCV.lblReqNbr.Text, 9)
            ...
            For i = 0 To Me.dgPost.Rows.Count - 1
                ...
                If Not Len(h.Cells(1).Value) = 0 Then
                    ...
                    InsertToGLTable(9, GetGeneralLedgerModuleName(9), frmPCV.lblReqNbr.Text, h.Cells(1).Value, h.Cells(2).Value, h.Cells(3).Value, h.Cells(4).Value, dbDR, dbCR, h.Cells(5).Value, h.Cells(6).Value, h.Cells(7).Value, h.Cells(8).Value, h.Cells(9).Value)
            ...
            MsgBox("Petty Cash Request " & frmPCV.lblReqNbr.Text & " Posted!", vbInformation, "System Message")
