...
Public Class frmAPV
    ...
    Public Sub SaveAPV()
        ...
        DeleteToGLTable(Me.lblAPVNbr.Text, 10)
        ...
        For i = 0 To Me.dgGLEntry.Rows.Count - 1
            ...
            Dim dbDR As Double = 0
            Dim dbCR As Double = 0
            ...
            If Not Len(h.Cells(1).Value) = 0 Then
                ...
                InsertToGLTable(10, GetGeneralLedgerModuleName(10), apvNumber, h.Cells(1).Value, h.Cells(2).Value, h.Cells(3).Value, h.Cells(4).Value, dbDR, dbCR, h.Cells(5).Value, h.Cells(6).Value, h.Cells(7).Value, h.Cells(8).Value, h.Cells(9).Value)
    ...
    Private Sub btUpdateAcctgEntry_Click(sender As Object, e As EventArgs) Handles btUpdateAcctgEntry.Click
        ...
        For i = 0 To Me.dgGLEntry.Rows.Count - 1
            ...
            If Not Len(h.Cells(1).Value) = 0 Then
                ...
                InsertToGLTable(10, GetGeneralLedgerModuleName(10), Me.lblAPVNbr.Text, h.Cells(1).Value, h.Cells(2).Value, h.Cells(3).Value, h.Cells(4).Value, dbDR, dbCR, h.Cells(5).Value, h.Cells(6).Value, h.Cells(7).Value, h.Cells(8).Value, h.Cells(9).Value)
