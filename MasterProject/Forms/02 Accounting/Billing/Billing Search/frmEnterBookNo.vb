    ...
    Private Sub btEnter_Click(sender As Object, e As EventArgs) Handles btEnter.Click
        ...
        Select Case Me.Tag
            ...
            Case "EXP INV"
                ...
                End If
            Case "EXP SOA"
                If frmSOAExport.SearchBooking(Me.txtBookNo.Text) = True Then
                    frmSOAExport.ChangeEnabledButtons(False, False, True, True, False, False, False, False, False, False)
                    frmSOAExport.EnableButtons2(True, True)
                    frmSOAExport.ClearEntries(True)
                    Me.Dispose()
                    Me.Close()
                Else
                    Exit Sub
