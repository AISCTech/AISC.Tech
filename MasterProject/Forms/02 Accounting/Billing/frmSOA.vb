...
Public Class frmSOA
    ...
    Public Sub SaveBilling()
        ...
        If Len(Me.lblRefNo.Text) = 0 Then
            'NEW BILLING
            Dim strRefNo As String = "BIB" & GetCtrlNbr(strCompanyCode, strSiteCode, "Billing_Import_Brokerage_Trucking_SOA")
...
ByVal blReOpen As Boolean, ByVal blUserInput As Boolean)
    ...
    Public Function SearchBooking(ByVal str As String) As Boolean
        ...
        Dim strsql As String = "SELECT * FROM v_importbookingheader WHERE v_importbookingheader.BookingNo = '" & str & "'"
    ...
    Public Sub ReOpenRecord() Implements ICommonFunction.ReOpenRecord
        ...
        If MsgBox("Are you sure you want to re-open billing : " & Me.lblRefNo.Text, MsgBoxStyle.Question + MsgBoxStyle.YesNo, "System Message") = MsgBoxResult.No Then
            Exit Sub
        End If
        strsql = "UPDATE bill_impsoa_main SET Cancel=FALSE, CancelDate=null, CancelBy=null, Posted=FALSE, PostedlDate=null, PostedBy=null WHERE RefNo = '" & Me.lblRefNo.Text & "'"
