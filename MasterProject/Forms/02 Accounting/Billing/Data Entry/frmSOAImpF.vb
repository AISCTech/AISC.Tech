...
Public Class frmSOAImpF


    Private Sub frmSOAImpF_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub RetrieveBillingMain(ByVal strCol As String, ByVal strVal As String)
        Dim strSQL As String = "SELECT * FROM bill_impfsoa_main WHERE " & strCol & " = '" & strVal & "' AND Cancel = FALSE"
    ...
    Private Sub RetrieveBillingCharges()
        Dim strSQL As String = "SELECT * FROM bill_impfsoa_charges WHERE RefNo = '" & Me.tslblRefNo.Text & "'"
    ...
    Private Sub RetrieveAcctgEntry()
        ClearAcctgEntry()
        Dim strSQL As String = "SELECT * FROM bill_impfsoa_acctg_entry WHERE RefNo = '" & Me.tslblRefNo.Text & "'"
    ...
    Private Sub SaveBillingMain()
        ...
        If Len(Me.tslblRefNo.Text) = 0 Then
            ...
            Dim strRefNo As String = "BIFSO" & GetCtrlNbr(strCompanyCode, strSiteCode, "Billing_Import_Forwarding_SOA")
            Me.tslblRefNo.Text = strRefNo
            Dim dtCurrent As Date = GetServerDate()
            strsql = "INSERT INTO bill_impfsoa_main (RefNo, HouseBL, Client, BilledTo, PrepDate, PrepBy, Vat, GrandTotal,  SOAAmt," &
                        " ExRate, SOANo,  Remarks, Posted, Cancel, AllowRelease, SISNo)" &
                        " VALUES (@RefNo, @HouseBL, @Client,  @BilledTo, @PrepDate, @PrepBy, @Vat, @GrandTotal, @SOAAmt," &
                        " @ExRate, @SOANo, @Remarks, @Posted, @Cancel, @AllowRelease, @SISNo)"
            ...
            With cmdSQL.Parameters
                ...
                .AddWithValue("@SOAAmt", CDbl(Me.txtSOA.Text))
                .AddWithValue("@ExRate", CDbl(Me.txtExRate.Text))
                .AddWithValue("@SOANo", Me.txtSOANo.Text)
        ...
        Else
            strsql = "UPDATE bill_impfsoa_main SET" &
                        " Client=@Client," &
                        " BilledTo=@BilledTo," &
                        " Vat=@Vat," &
    ...
    Private Sub SaveBillingCharges()
        ...
        strsql = "DELETE FROM bill_impfsoa_charges WHERE RefNo = '" & Me.tslblRefNo.Text & "'"
        ...
        For intRow = 0 To Me.dtgBilling.RowCount - 1
            If Len(Me.dtgBilling.Rows(intRow).Cells(0).Value) > 0 Then
                strsql = "INSERT INTO bill_impfsoa_charges (RefNo, RowNo, Charges, Terms, Qty, Amount, Total, WithVat, Remarks, CHCode)" &
    ...
    Private Sub SaveAcctgEntry()
        Dim strsql As String = "DELETE FROM bill_impfsoa_acctg_entry WHERE RefNo = '" & tslblRefNo.Text & "'"
        ...
        For ctrRow = 0 To Me.dtgAcctgTitle.Rows.Count - 1
            With Me.dtgAcctgTitle.Rows(ctrRow)
                strsql = "INSERT INTO bill_impfsoa_acctg_entry (RefNo, Branch, AcctCode, AcctTitle, SubAcctCode," &
    ...
    Private Sub tscmdCancel_Click(sender As Object, e As EventArgs) Handles tscmdCancel.Click
        ...
        If MsgBox("Are you sure you want cancel billing : " & Me.tslblRefNo.Text, MsgBoxStyle.Question + MsgBoxStyle.YesNo, "System Message") = MsgBoxResult.No Then
            Exit Sub
        End If
        strsql = "UPDATE bill_impfsoa_main SET Cancel=TRUE, DateCancel=@DateCancel, CancelBy= '" & strCurrentUser & "' WHERE RefNo = '" & Me.tslblRefNo.Text & "' AND Cancel = FALSE"
    ...
    Private Sub tscmdPost_Click(sender As Object, e As EventArgs) Handles tscmdPost.Click
        ...
        Dim strsql As String = "UPDATE bill_impfsoa_main SET" &
                                " SOANo = @SOANo, " &
                                " Posted = @Posted, " &
                                " PostedBy = @PostedBy, " &
        ...
        Try
            ...
            MsgBox("Billing Reference No. " & Me.tslblRefNo.Text & " is Posted!" & vbNewLine &
                    "S.O.A.#: " & strSOA, vbInformation, "System Message")
    ...
    Private Sub PHPToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles PHPToolStripMenuItem1.Click
        If Me.sslblStatus1.Text <> "Posted" Then
            MsgBox("Cannot Print Charge Invoice or S.O.A. if Billing is not yet Posted!", MsgBoxStyle.Exclamation, "System Message")
            Exit Sub
        End If
        PrintCurrency = "PHP"
        frmPrintPreview.PrintImpFSOA()
        frmPrintPreview.ShowDialog()
    End Sub

    Private Sub USDToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles USDToolStripMenuItem1.Click
        If Me.sslblStatus1.Text <> "Posted" Then
            MsgBox("Cannot Print Charge Invoice or S.O.A. if Billing is not yet Posted!", MsgBoxStyle.Exclamation, "System Message")
            Exit Sub
        End If
    ...
    Private Sub PHPToolStripMenuItem3_Click(sender As Object, e As EventArgs) Handles PHPToolStripMenuItem3.Click
        If Me.sslblStatus1.Text <> "Open" Then
            MsgBox("Billing Already " & Me.sslblStatus1.Text, MsgBoxStyle.Exclamation, "System Message")
            Exit Sub
        End If
        PrintCurrency = "PHP"
        frmPrintPreview.PrintIMPFSOA_D()
        frmPrintPreview.ShowDialog()
    End Sub

    Private Sub USDToolStripMenuItem3_Click(sender As Object, e As EventArgs) Handles USDToolStripMenuItem3.Click
        If Me.sslblStatus1.Text <> "Open" Then
            MsgBox("Billing Already " & Me.sslblStatus1.Text, MsgBoxStyle.Exclamation, "System Message")
            Exit Sub
        End If
    ...
    Private Sub PHPToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles PHPToolStripMenuItem.Click
        If Me.sslblStatus1.Text <> "Posted" Then
            MsgBox("Cannot Print Charge Invoice or S.O.A. if Billing is not yet Posted!", MsgBoxStyle.Exclamation, "System Message")
            Exit Sub
        End If
        PrintCurrency = "PHP"
        frmPrintPreview.PrintImpFSOA_S()
        frmPrintPreview.ShowDialog()
    End Sub

    Private Sub USDToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles USDToolStripMenuItem.Click
        If Me.sslblStatus1.Text <> "Posted" Then
            MsgBox("Cannot Print Charge Invoice or S.O.A. if Billing is not yet Posted!", MsgBoxStyle.Exclamation, "System Message")
            Exit Sub
        End If
