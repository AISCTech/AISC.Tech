...
Public Class frmSOAExport
    ...
    Private Sub frmSOAExport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        FillGridComboBox(Me.colSCharges, "Select ChargeName from tbl_charges where CRAcctCode = '2020'", "ChargeName")
    End Sub
    ...
    Public Sub SaveBilling()
        ...
        If Len(Me.lblRefNo.Text) = 0 Then
            'NEW BILLING
            Dim strRefNo As String = "BEX" & GetCtrlNbr(strCompanyCode, strSiteCode, "Billing_Export_SOA")
...
ByVal blReOpen As Boolean, ByVal blUserInput As Boolean)
    ...
    Public Sub ReOpenRecord() Implements ICommonFunction.ReOpenRecord
        ...
        If MsgBox("Are you sure you want to re-open billing : " & Me.lblRefNo.Text, MsgBoxStyle.Question + MsgBoxStyle.YesNo, "System Message") = MsgBoxResult.No Then
            Exit Sub
        End If
        strsql = "UPDATE bill_expsoa_main SET Cancel=FALSE, CancelDate=null, CancelBy=null, Posted=FALSE, PostedlDate=null, PostedBy=null WHERE RefNo = '" & Me.lblRefNo.Text & "'"
    ...
    Private Sub DraftSOAToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DraftSOAToolStripMenuItem.Click
        If Len(Me.lblRefNo.Text) = 0 Then
            MsgBox("Nothing to Print!", vbInformation, "System Message")
            Exit Sub
        End If
